...
let create_skills=()=>{
  let skills=[];
    let num_skills=rand(10)+2
    for (let j=0;j<num_skills;j++){
      let skill={
        id:''+j,
        name:lorem.generateWords(1+rand(2))
      }
      skills.push(skill)
    }
  return skills
