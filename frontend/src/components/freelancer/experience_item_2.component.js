            ...
            <div  style={{padding:20,display:'flex',flex:1,flexDirection:'column',
                backgroundColor:index%2==1?WHITE:GRAY_4}}>    
                    ...
                    <div style={{marginTop:10}}>
                        <LabeledInput 
                            size={textSizes.NORMAL} value={card.number} label='Number :'
                            type='number'
                    ...
                    <div style={styles.row}>
                        ...
                        <LabeledInput 
                            size={textSizes.SMALL} value={card.owner_name} label='Name :'
                            type='text'
                        ...
                        <LabeledInput 
                            size={textSizes.SMALL} value={this.formatDate(card.expired_date)} label='Expired :'
                            type='date'
                    ...
                    <div style={styles.row}>
                        ...
                        <LabeledInput 
                            size={textSizes.SMALL} value={card.email} label='Email :'
                            type='email'
                        ...
                        <LabeledInput 
                            size={textSizes.SMALL} value={card.ccv} label='CCV :'
                            type='password'
