...
class AuthModal extends Component {
    ...
    testLogin=()=>{
        ...
        if (this.state.username==='iamcompany@gmail.com' && this.state.password==='123qweASD') {
        ...
        else if (this.state.username==='iamfreelancer@gmail.com' && this.state.password==='123qweASD') {
            alert('Sign in success')
            this.props.loginSuccess({
        ...
        else if (this.state.username==='iamadmin@gmail.com' && this.state.password==='123qweASD') {
            alert('Sign in success')
            this.props.loginSuccess({
            ...
            alert('Sign in fail, please check again username and password .')
        }
    }
